...
const plans = [
    {
        ...
        name: "Basic plan",
        price: 10,
        features: "Includes up to 10 users, 20GB individual data and access to all features.",
        limitedTime: true,
    },
    {
        id: "business",
        name: "Business plan",
        price: 20,
        features: "Includes up to 20 users, 40GB individual data and access to all features.",
    },
    {
        id: "enterprise",
        name: "Enterprise plan",
        price: 40,
        features: "Unlimited users, unlimited individual data and access to all features.",
    },
];
        ...
        <>
            <div className="flex p-6 align-center justify-between flex-col md:flex-row ">
                <div className="flex flex-col space-y-6">
                    <h3 className="text-3xl font-regular text-[#144A6C]"> Subscription Plans</h3>
                    <span className="text-[20px] text-gray-500">These are all the plans offered by us. Simply select a plan, pay for <br /> it and you are ready to go.
                        Upgrade or cancel any time.</span>
                </div>
                        ...
                        {plans.map((plan) => {
                            ...
                            return (
                                <div key={plan.id} className="space-y-0">
                                    ...
                                    ${isSelected ? "border-[#144A6C] bg-[#E6F0FA]" : "border-gray-200 bg-white"}
                                `}
                                    >
                                    ...
                                    >
                                        <div className="flex items-baseline justify-between">
                                            <div className="flex items-baseline space-x-1">
                                                <p className="text-3xl font-medium text-gray-900">${plan.price}</p>
                                            ...
                                            {isSelected && (
                                                ...
                                                >
                                                    <button className="border border-[#ccc] rounded-lg py-2 px-8 text-[#144A6C] text-sm">Cancel</button>
                                                </button>
                                            )}
                                        </div>

                                        <p className="mt-2 text-sm text-gray-500">{plan.features}</p>
                                    </div>
                                </div>
                            );
                        })}
