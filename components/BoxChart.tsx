...
const titles = ['Doctor', 'Patient', 'Inventory', 'Staff', 'Clinic', 'Room', 'Appointment', 'Bill', 'Quote', 'Note'];
...
const BoxChart = () => {
    ...
    const data: (number | null)[][] = Array.from({ length: 7 }, (_, rowIndex) =>
        ...
        <div className="p-6 w-full overflow-x-auto">
            ...
            <div className="space-y-3">
                ...
                {data.map((row, rowIndex) => (
                    <div key={rowIndex}  className="flex gap-2 w-full overflow-x-auto items-center mb-4">
                        {/* Y-axis label */}
