...
const PatientSummary = dynamic(() => import('../components/PatientSummary'), {
    ssr: false,
});
const LineChart = dynamic(() => import('../components/LineChart'), {
    ssr: false,
});
const Dashboardapex = dynamic(() => import("../components/Dashboardapex"), {
    ssr: false,
});
const BoxChart = dynamic(() => import("../components/BoxChart"), {
    ssr: false,
});
interface Doctor {
    id: string;
