...
export default function Batch() {
  return (
    <>
      <div className="bg-white py-16 px-6 md:px-20 mt-[100px] mb-[100px]">
        <section className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row gap-12">
            {/* Left Section */}
            <div className="flex-1">
              <span className="text-sm text-green-700 font-semibold mb-2 block">• Custom Budgets</span>
            ...
            <div className="flex-1 relative">
              ...
              <div
                className="bg-[#F8ECF8] rounded-2xl h-[420px] relative p-2"
                style={{
              ...
              <div className="absolute top-12 left-1/2 -translate-x-1/2 w-full max-w-lg h-[300px] z-10">
                <div className="relative top-[1rem] left-[51%] -translate-x-1/2">
                  <Image src="/mysides.jpg" alt="Expense graphic" width={700} height={600} className="rounded-xl object-cover w-full shadow-lg" />
                </div>
              </div>
            </div>
          </div>
