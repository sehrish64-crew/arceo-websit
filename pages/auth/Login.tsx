            ...
            <div className="min-h-screen p-4 overflow-hidden">
                ...
                <div className="flex h-[calc(100vh-30px)] overflow-hidden rounded-2xl bg-white">
                    ...
                    <div className="w-full lg:w-1/2 flex items-center justify-center px-6 sm:px-12 md:px-24 bg-white">
                        <div className="w-full max-w-md">
                            <div className="text-center">
                                ...
                                <h1 className="text-2xl font-semibold text-[#144A6C] mt-6">Welcome back</h1>
                    ...
                    <div className="hidden lg:block relative w-1/2 h-auto">
                        <Image
                            src="/bg-img.jpg" // Make sure this image exists in /public
                            alt="Dental"
                            fill
                        ...
                        <div className="absolute bottom-6 left-6 right-6 bg-white/30 text-[#fff] p-6 rounded-xl" style={{ backdropFilter: "blur(24px)" }}>
                            <p className="text-3xl font-medium text-center">
                                "A healthy smile is more than just beauty — it’s a reflection of good health,
                                self-care, and the confidence to share your joy with the world."
                            </p>
                        </div>
                    </div>
