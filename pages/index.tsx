...
import FeatureCards from "../pages/components/FeatureCards";
import MultiAccount from "../pages/components/MultiAccount";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-[#4e758d] mb-6 leading-relaxed mt-10">
                ...
                clinic management system ixxs designed by healthcare
