    ...
    <>
      ...
      <div className="flex flex-col h-full bg-white lg:rounded-r-lg">
        ...
        <div className="set-header pb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 flex-shrink-0 lg:rounded-tr-lg">
          ...
          <div className="flex rounded-lg text-[#144A6C] font-regular transition-colors hover:bg-[#FAFAFA] col-gap-2 items-center justify-center button_styles">
            <div>
              ...
              <EditClinic isOpen2={isOpen2} onClose={() => setIsOpen2(false)} />
            </div>
